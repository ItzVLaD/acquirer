...
class _CategoryFormState extends State<CategoryForm> {
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            ...
            onChanged: (value) {
              setState(() {
                if (idController.text != '' && categoriesId.contains(idController.text)) {
                  final category = CategoryController.instance.allCategories.firstWhere((category) => category.id == idController.text);
  ...
  void saveProduct() {
    if (idController.text != '' && nameController.text != '' && (image != null || imagePath != null)) {
      ...
      CategoryController.instance.uploadCategory(category, image);
      clearFields();
